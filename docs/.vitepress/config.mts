    ...
    sidebar: {
      '/guide/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'asList', link: '/guide/common/as-list' },
            { text: 'highlightSplit', link: '/guide/common/highlight-split' },
            { text: 'isEnvOn', link: '/guide/common/is-env-on' },
            { text: 'noNull', link: '/guide/common/no-null' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'encodeURIComponentFixed', link: '/guide/text/encode-uri-component-fixed' },
            { text: 'formatPhoneNumber', link: '/guide/text/format-phone-number' },
            { text: 'lengthOfEn', link: '/guide/text/length-of-en' },
            { text: 'tagTemplate', link: '/guide/text/tag-template' },
            { text: 'toEndsWith', link: '/guide/text/to-ends-with' },
            { text: 'toStartsWith', link: '/guide/text/to-starts-with' },
          ],
        },
        {
          text: '树结构',
          collapsed: true,
          items: [
            { text: 'listToTree', link: '/guide/tree/list-to-tree' },
            { text: 'mapTree', link: '/guide/tree/map-tree' },
            { text: 'traverseTree', link: '/guide/tree/traverse-tree' },
          ],
        },
        {
          text: '杂项',
          collapsed: true,
          items: [{ text: 'OmnError', link: '/guide/misc/omn-error' }],
        },
      ],
    },
